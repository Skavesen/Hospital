namespace EPatient.Migrations
{
    ...
    public partial class DataSeeder : DbMigration
    {
        public override void Up()
        {
            ...
            Sql("INSERT INTO \"dbo\".\"Users\" (\"Name\",\"Surname\",\"Username\",\"Password\",\"RoleId\",\"PavilionId\") VALUES ('Wanda', 'Hans', 'wandahans', 'jbdGxQpaiR93MPnkhe8cE4PblcMUYYy+3ke4FYJjR4Xlms+V', 8, 1)");
            ...
            Sql("INSERT INTO \"dbo\".\"Users\" (\"Name\",\"Surname\",\"Username\",\"Password\",\"RoleId\",\"PavilionId\") VALUES ('Marcus', 'Kula', 'marcuskula', 'jbdGxQpaiR93MPnkhe8cE4PblcMUYYy+3ke4FYJjR4Xlms+V', 8, 2)");
            ...
            Sql("INSERT INTO \"dbo\".\"Users\" (\"Name\",\"Surname\",\"Username\",\"Password\",\"RoleId\",\"PavilionId\") VALUES ('Erick', 'Lightle', 'ericklightle', 'jbdGxQpaiR93MPnkhe8cE4PblcMUYYy+3ke4FYJjR4Xlms+V', 8, 3)");
            ...
            Sql("INSERT INTO \"dbo\".\"Users\" (\"Name\",\"Surname\",\"Username\",\"Password\",\"RoleId\",\"PavilionId\") VALUES ('Emily', 'Walson', 'emilywalson', 'jbdGxQpaiR93MPnkhe8cE4PblcMUYYy+3ke4FYJjR4Xlms+V', 8, 4)");

            for (int i = 3; i <= 14; i++)
            {
                Sql("INSERT INTO \"dbo\".\"Timetables\" (\"DayOfTheWeek\",\"StartTime\",\"EndTime\",\"DayOff\",\"UserId\") VALUES (1, '2023-06-20 08:00:00', '2023-06-20 16:00:00', '0', " + i + ")");
            ...
            Sql("INSERT INTO \"dbo\".\"Patients\" (\"Name\",\"Surname\",\"Birthday\",\"Gender\",\"Phone\",\"Email\",\"Allergies\") VALUES ('Dex', 'Sandy', '1998-03-02', 0, '06845231', 'dexsandygmail.com', 'Latex, Gluten')");
            Sql("INSERT INTO \"dbo\".\"Patients\" (\"Name\",\"Surname\",\"Birthday\",\"Gender\",\"Phone\",\"Email\",\"Allergies\") VALUES ('Meryl', 'Walter', '2015-03-08', 1, '0698447521', 'merylwaltergmail.com', 'Tetracycline')");
            Sql("INSERT INTO \"dbo\".\"Patients\" (\"Name\",\"Surname\",\"Birthday\",\"Gender\",\"Phone\",\"Email\") VALUES ('Jony', 'Kay', '1996-12-09', 1, '06712547', 'jonykaygmail.com')");
            Sql("INSERT INTO \"dbo\".\"Patients\" (\"Name\",\"Surname\",\"Birthday\",\"Gender\",\"Phone\",\"Email\") VALUES ('Velma', 'Doe', '1970-03-06', 0, '068784512', 'velmadoegmail.com')");
            Sql("INSERT INTO \"dbo\".\"Patients\" (\"Name\",\"Surname\",\"Birthday\",\"Gender\",\"Phone\",\"Email\",\"Allergies\") VALUES ('Caleb', 'Prue', '1991-10-06', 1, '0698447521', 'calebpruegmail.com', 'Penicillin')");
