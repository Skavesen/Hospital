...
namespace EPatient.Views.Staff
{
    public partial class ReservationControl : UserControl
    {
        ...
        private void StyleGrid()
        {
            ...
            gridViewReservation.Columns[4].Width = 160;
        }
        ...
        private DataTable FillTable(String search = null, DateTime? date = null)
        {
            ...
            dataTable.Columns.Add("Пациент");
            dataTable.Columns.Add("Услуги");
            dataTable.Columns.Add("Дата");
            dataTable.Columns.Add("Выполнение");
            ...
            foreach (var reservation in reservations)
            {
                ...
                row["Done"] = reservation.Done ? "Да" : "нет";
        ...
        private void btnFolder_Click(object sender, EventArgs e)
        {
            ...
            {
                MetroMessageBox.Show(this, "Бронирований нет", "Info", MessageBoxButtons.OK,
