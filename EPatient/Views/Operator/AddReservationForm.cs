...
namespace EPatient.Views.Operator
{
    public partial class AddReservationForm : MetroFramework.Forms.MetroForm
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MetroMessageBox.Show(this, "Вы должны выбрать пациента, услугу, врача", "Error", MessageBoxButtons.OK,
            ...
            {
                MetroMessageBox.Show(this, "Error", "Персонал не работает в выбранный день и время", MessageBoxButtons.OK,
                    MessageBoxIcon.Error);
                return;
            }
            ...
            {
                MetroMessageBox.Show(this, "Error", "Персонал занят в выбранное время", MessageBoxButtons.OK,
                    MessageBoxIcon.Error);
                return;
            }
            //save reservation
            ...
            if (MetroMessageBox.Show(this, "Хотите распечатать счет?", "Message", MessageBoxButtons.YesNo,
