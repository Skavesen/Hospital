...
namespace EPatient.Views.Operator
{
    public partial class AddQuickReservation : MetroFramework.Forms.MetroForm
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MetroMessageBox.Show(this, "Вы должны выбрать пациента и услугу", "Error", MessageBoxButtons.OK,
            ...
            if (doctorId == 0)
            {
                MetroMessageBox.Show(this, "Сегодня нет дежурного врача! Свяжитесь с администратором!", "error",
