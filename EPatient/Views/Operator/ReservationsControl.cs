...
namespace EPatient.Views.Operator
{
    public partial class ReservationsControl : MetroFramework.Controls.MetroUserControl
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                if (MetroMessageBox.Show(this, "Вы уверены, что хотите удалить эту запись?", "Message",
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            using (AddReservationForm frm = new AddReservationForm())
            {
                if (frm.ShowDialog() == DialogResult.OK)
                {
                    try
                    {
                        MetroMessageBox.Show(this, "Успех", "Message", MessageBoxButtons.OK,
        ...
        private void btnPay_Click(object sender, EventArgs e)
        {
            ...
            {
                MetroMessageBox.Show(this, "Бронирования нет!", "Info", MessageBoxButtons.OK,
            ...
            else
            {
                ...
                if (id != 0)
                {
                    ...
                    if (reservation.Paid)
                    {
                        MetroMessageBox.Show(this, "Бронь только что оплачена", "Warning", MessageBoxButtons.OK,
                            MessageBoxIcon.Warning);
                        return;
                    }

                    if (MetroMessageBox.Show(this, "Хотите распечатать счет?", "Pay", MessageBoxButtons.YesNo,
                            MessageBoxIcon.Asterisk) == DialogResult.Yes)
                    {
                        ...
                        gridView.DataSource = FillTable();
                        PrintReservation();
                        MetroMessageBox.Show(this, "Успешно оплачен!", "Success", MessageBoxButtons.OK,
