...
namespace EPatient.Views.Admin
{
    public partial class EmergencyDoctorControl : MetroFramework.Controls.MetroUserControl
    {
        ...
        private void StyleGrid()
        {
            ...
            metroGrid1.Columns[3].HeaderText = "Фамилия";
            metroGrid1.Columns[4].Width = 145;
            metroGrid1.Columns[4].HeaderText = "Отделение";
        }
        ...
        private void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            if (query.Count == 0)
            {
                MetroFramework.MetroMessageBox.Show(this, "Нет ни врача, ни медсестры", "Info", MessageBoxButtons.OK,
