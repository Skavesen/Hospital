    ...
    public partial class TimetablesControl : MetroUserControl
    {
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            if (usersBindingSource.Current is User selectedUser)
            {
                ...
                userLabel.Text = "Расписание для " + _currentUser.Name;
                timetablePanel.Show();
                FillTimetable();
            }
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (ValidateStartTime())
            {
                ...
                MetroMessageBox.Show(this, "Сохранение прошло успешно", "Message", MessageBoxButtons.OK,
                    MessageBoxIcon.Question);
            }
            else
            {
                MetroMessageBox.Show(this, "Время начала должно быть меньше времени окончания", "Message", MessageBoxButtons.OK,
